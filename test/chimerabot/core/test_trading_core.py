...
from chimerabot.core.trading_core import StrategyType, TradingCore
...
class TradingCoreTest(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("chimerabot.core.trading_core.Clock")
    ...
    def test_detect_strategy_type(self):
        ...
        with patch.object(Path, 'exists') as mock_exists:
            ...
            with patch("chimerabot.core.trading_core.STRATEGIES", ["pure_market_making"]):
    ...
    @patch("chimerabot.core.trading_core.MarketsRecorder")
    @patch("chimerabot.core.trading_core.SQLConnectionManager")
    ...
    @patch("chimerabot.core.trading_core.importlib")
    @patch("chimerabot.core.trading_core.inspect")
    @patch("chimerabot.core.trading_core.sys")
    ...
    @patch("chimerabot.core.trading_core.RateOracle")
    ...
    async def test_stop_strategy(self):
        ...
        with patch("chimerabot.core.trading_core.RateOracle") as mock_rate_oracle:
            mock_oracle = Mock()
    ...
    @patch("chimerabot.core.trading_core.PerformanceMetrics")
    ...
    @patch("chimerabot.client.config.client_config_map.AnonymizedMetricsEnabledMode.get_collector")
    @patch("chimerabot.core.trading_core.RateOracle")
    ...
    @patch("chimerabot.core.trading_core.get_strategy_starter_file")
