...
from chimerabot.connector.exchange.binance import binance_constants as CONSTANTS, binance_web_utils
...
class TestTradingPairFetcher(unittest.TestCase):
    ...
    @patch("chimerabot.core.utils.trading_pair_fetcher.TradingPairFetcher._all_connector_settings")
    @patch("chimerabot.core.utils.trading_pair_fetcher.TradingPairFetcher._sf_shared_instance")
    ...
    @patch("chimerabot.core.utils.trading_pair_fetcher.TradingPairFetcher._all_connector_settings")
    @patch("chimerabot.core.utils.trading_pair_fetcher.TradingPairFetcher._sf_shared_instance")
    @patch("chimerabot.client.config.security.Security.connector_config_file_exists")
    @patch("chimerabot.client.config.security.Security.wait_til_decryption_done")
