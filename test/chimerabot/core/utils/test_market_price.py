...
import chimerabot.connector.exchange.binance.binance_constants as CONSTANTS
import chimerabot.connector.exchange.binance.binance_web_utils as web_utils
import chimerabot.core.utils.market_price as market_price
...
class MarketPriceUnitTests(unittest.TestCase):
    ...
    @aioresponses()
    @patch("chimerabot.client.settings.ConnectorSetting.non_trading_connector_instance_with_default_configuration")
