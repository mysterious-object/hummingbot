"""
Unit tests for chimerabot.core.utils.ssl_cert
"""
...
from chimerabot.core.gateway import GatewayPaths
from chimerabot.core.utils.ssl_cert import (
    certs_files_exist,
...
class SslCertTest(unittest.TestCase):
    ...
    def test_create_self_sign_certs(self):
        ...
        with tempfile.TemporaryDirectory() as tempdir:
            ...
            with patch("chimerabot.core.utils.ssl_cert.get_gateway_paths", return_value=mock_gateway_paths):
