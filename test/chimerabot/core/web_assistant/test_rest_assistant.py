...
from chimerabot.core.web_assistant.connections.data_types import RESTMethod, RESTRequest, RESTResponse, WSRequest
from chimerabot.core.web_assistant.connections.rest_connection import RESTConnection
...
class RESTAssistantTest(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("chimerabot.core.web_assistant.connections.rest_connection.RESTConnection.call")
