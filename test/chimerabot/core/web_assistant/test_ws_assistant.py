...
from chimerabot.core.web_assistant.connections.data_types import RESTRequest, WSJSONRequest, WSRequest, WSResponse
from chimerabot.core.web_assistant.connections.ws_connection import WSConnection
from chimerabot.core.web_assistant.ws_assistant import WSAssistant
from chimerabot.core.web_assistant.ws_post_processors import WSPostProcessorBase
from chimerabot.core.web_assistant.ws_pre_processors import WSPreProcessorBase
...
class WSAssistantTest(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("chimerabot.core.web_assistant.connections.ws_connection.WSConnection.connect")
    ...
    @patch("chimerabot.core.web_assistant.connections.ws_connection.WSConnection.disconnect")
    async def test_disconnect(self, disconnect_mock):
        await (self.ws_assistant.disconnect())

        disconnect_mock.assert_called()

    @patch("chimerabot.core.web_assistant.connections.ws_connection.WSConnection.send")
    ...
    @patch("chimerabot.core.web_assistant.connections.ws_connection.WSConnection.receive")
    ...
    @patch(
        "chimerabot.core.web_assistant.connections.ws_connection.WSConnection.connected",
