...
from chimerabot.core.api_throttler.async_throttler import AsyncRequestContext, AsyncThrottler
from chimerabot.core.api_throttler.data_types import LinkedLimitWeightPair, RateLimit, TaskLog
from chimerabot.logger.struct_logger import METRICS_LOG_LEVEL

TEST_PATH_URL = "/chimerabot"
TEST_POOL_ID = "TEST"
...
class AsyncThrottlerUnitTests(unittest.TestCase):
    ...
    @patch("chimerabot.core.api_throttler.async_throttler.AsyncRequestContext._time")
