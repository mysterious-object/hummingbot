...
class ConnectorManagerTest(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("chimerabot.core.connector_manager.create_paper_trade_market")
    ...
    @patch("chimerabot.core.connector_manager.get_connector_class")
    @patch("chimerabot.core.connector_manager.Security")
    @patch("chimerabot.core.connector_manager.AllConnectorSettings")
