...
class DeriveRateSourceTest(unittest.TestCase):
    ...
    @patch("chimerabot.connector.exchange.derive.derive_exchange.DeriveExchange._make_trading_rules_request", new_callable=AsyncMock)
    @patch("chimerabot.connector.exchange.derive.derive_exchange.DeriveExchange.get_all_pairs_prices", new_callable=AsyncMock)
    @aioresponses()
