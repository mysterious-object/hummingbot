...
from chimerabot.client.config.config_helpers import ClientConfigAdapter
...
from chimerabot.core.event.events import BuyOrderCreatedEvent, MarketEvent, OrderExpiredEvent, SellOrderCreatedEvent
from chimerabot.model.order import Order
from chimerabot.model.trade_fill import TradeFill
from chimerabot.remote_iface.mqtt import MQTTGateway, MQTTMarketEventForwarder


@patch("chimerabot.remote_iface.mqtt.MQTTGateway._INTERVAL_HEALTH_CHECK", 0.0)
@patch("chimerabot.remote_iface.mqtt.MQTTGateway._INTERVAL_RESTART_LONG", 0.0)
class RemoteIfaceMQTTTests(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.hbapp = ChimeraBotApplication(client_config_map=self.client_config_map)
        ...
        self.restart_interval_patcher = patch(
            'chimerabot.remote_iface.mqtt.MQTTGateway._INTERVAL_RESTART_SHORT',
        ...
        self.patch_loggers_patcher = patch(
            'chimerabot.remote_iface.mqtt.MQTTGateway.patch_loggers'
        )
    ...
    @patch("chimerabot.client.command.balance_command.BalanceCommand.balance")
    ...
    @patch("chimerabot.client.command.config_command.ConfigCommand.config")
    ...
    @patch("chimerabot.client.command.history_command.HistoryCommand.history")
    ...
    @patch("chimerabot.client.command.import_command.load_strategy_config_map_from_file")
    @patch("chimerabot.client.command.status_command.StatusCommand.status_check_all")
    @patch("chimerabot.client.command.import_command.ImportCommand.import_config_file", new_callable=AsyncMock)
    ...
    @patch("chimerabot.client.command.status_command.StatusCommand.strategy_status", new_callable=AsyncMock)
    ...
    @patch("chimerabot.client.command.stop_command.StopCommand.stop")
    ...
    @patch("chimerabot.remote_iface.mqtt.mqtts_logger", None)
    ...
    @patch("chimerabot.remote_iface.mqtt.MQTTGateway.health", new_callable=PropertyMock)
    ...
    def test_eevent_queue_factory(self):
        self.start_mqtt()
        from chimerabot.remote_iface.mqtt import EEventQueueFactory, ExternalEventFactory
    ...
    def test_eevent_listener_factory(self):
        self.start_mqtt()
        from chimerabot.remote_iface.mqtt import ExternalEventFactory
    ...
    def test_etopic_queue_factory(self):
        self.start_mqtt()
        from chimerabot.remote_iface.mqtt import ETopicQueueFactory, ExternalTopicFactory
    ...
    def test_etopic_listener_factory(self):
        self.start_mqtt()
        from chimerabot.remote_iface.mqtt import ExternalTopicFactory
    ...
    def test_external_events_add_remove(self):
        self.start_mqtt()
        from chimerabot.remote_iface.mqtt import MQTTGateway
    ...
    def test_mqtt_log_handler(self):
        ...
        from chimerabot.remote_iface.mqtt import MQTTLogHandler
        self.start_mqtt()
        ...
        logger = ChimeraBotLogger('testlogger')
    ...
    def test_market_events(self):
        self.start_mqtt()
        from chimerabot.core.data_type.trade_fee import AddedToCostTradeFee, DeductedFromReturnsTradeFee
        from chimerabot.remote_iface.mqtt import MQTTGateway
    ...
    def test_etopic_listener_class(self):
        from chimerabot.remote_iface.mqtt import ETopicListener
    ...
    def test_eevent_queue_factory_class(self):
        from chimerabot.remote_iface.mqtt import EEventQueueFactory
        self.start_mqtt()
    ...
    def test_eevent_listener_factory_class(self):
        from chimerabot.remote_iface.mqtt import EEventListenerFactory
        self.start_mqtt()
    ...
    def test_mqtt_external_events_class(self):
        from chimerabot.remote_iface.messages import ExternalEventMessage
        from chimerabot.remote_iface.mqtt import MQTTExternalEvents
    ...
    def test_etopic_publisher(self):
        self.start_mqtt()
        from chimerabot.remote_iface.mqtt import EMTopicPublisher, ETopicPublisher
        test_msg = {
            "a": "test",
            "b": 1,
            "c": False,
