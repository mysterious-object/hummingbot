...
from chimerabot.client.ui.interface_utils import (
    format_bytes,
...
class InterfaceUtilsTest(unittest.TestCase):
    ...
    @patch("chimerabot.client.ui.interface_utils._sleep", new_callable=AsyncMock)
    ...
    @patch("chimerabot.client.ui.interface_utils._sleep", new_callable=AsyncMock)
    @patch("chimerabot.client.ui.interface_utils.PerformanceMetrics.create", new_callable=AsyncMock)
