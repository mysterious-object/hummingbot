...
class LoginPromptTest(unittest.TestCase):
    ...
    @patch("chimerabot.client.ui.message_dialog")
    @patch("chimerabot.client.ui.input_dialog")
    @patch("chimerabot.client.config.security.Security.login")
    @patch("chimerabot.client.config.security.Security.new_password_required")
