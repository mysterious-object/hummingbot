...
from chimerabot.core.data_type.trade import Trade
from chimerabot.core.data_type.trade_fee import AddedToCostTradeFee, DeductedFromReturnsTradeFee, TokenAmount
from chimerabot.core.rate_oracle.rate_oracle import RateOracle
from chimerabot.model.order import Order  # noqa — Order needs to be defined for TradeFill
from chimerabot.model.order_status import OrderStatus  # noqa — Order needs to be defined for TradeFill
...
class PerformanceMetricsUnitTest(unittest.TestCase):
    ...
    @patch('chimerabot.client.performance.PerformanceMetrics._is_trade_fill')
