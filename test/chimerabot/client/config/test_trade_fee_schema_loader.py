...
class TestTradeFeeSchemaLoader(unittest.TestCase):
    ...
    @patch("chimerabot.client.config.trade_fee_schema_loader.AllConnectorSettings")
    @patch("chimerabot.client.config.trade_fee_schema_loader.fee_overrides_config_map")
