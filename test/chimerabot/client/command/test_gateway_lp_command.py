...
from chimerabot.client.command.gateway_lp_command import GatewayLPCommand
from chimerabot.connector.gateway.common_types import ConnectorType
...
class GatewayLPCommandTest(unittest.TestCase):
    ...
    @patch('chimerabot.client.command.gateway_lp_command.safe_ensure_future')
    ...
    @patch('chimerabot.core.gateway.gateway_http_client.GatewayHttpClient.get_connector_chain_network')
    @patch('chimerabot.core.gateway.gateway_http_client.GatewayHttpClient.get_default_wallet')
    async def test_position_info_no_positions(self, mock_wallet, mock_chain_network):
        ...
        with patch('chimerabot.connector.gateway.gateway_lp.GatewayLp') as MockLP:
    ...
    @patch('chimerabot.core.gateway.gateway_http_client.GatewayHttpClient.get_connector_chain_network')
    @patch('chimerabot.core.gateway.gateway_http_client.GatewayHttpClient.get_default_wallet')
    @patch('chimerabot.connector.gateway.common_types.get_connector_type')
    ...
    @patch('chimerabot.client.command.gateway_api_manager.begin_placeholder_mode')
    @patch('chimerabot.core.gateway.gateway_http_client.GatewayHttpClient.get_connector_chain_network')
    @patch('chimerabot.core.gateway.gateway_http_client.GatewayHttpClient.get_default_wallet')
    @patch('chimerabot.connector.gateway.common_types.get_connector_type')
    async def test_add_liquidity_uses_pool_token_order(self, mock_connector_type, mock_wallet, mock_chain_network, mock_placeholder):
        ...
        with patch('chimerabot.connector.gateway.gateway_lp.GatewayLp') as MockLP:
            ...
            with patch('chimerabot.client.command.command_utils.GatewayCommandUtils.enter_interactive_mode') as mock_enter:
    ...
    async def test_position_info_uses_pool_token_order(self, mock_connector_type, mock_wallet, mock_chain_network, mock_placeholder):
        ...
        with patch('chimerabot.connector.gateway.gateway_lp.GatewayLp') as MockLP:
            ...
            with patch('chimerabot.client.command.command_utils.GatewayCommandUtils.enter_interactive_mode') as mock_enter:
                with patch('chimerabot.client.command.command_utils.GatewayCommandUtils.exit_interactive_mode') as mock_exit:
                    mock_enter.return_value = AsyncMock()
