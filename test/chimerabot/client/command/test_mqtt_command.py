...
@patch("chimerabot.remote_iface.mqtt.MQTTGateway._INTERVAL_RESTART_SHORT", 0.0)
class RemoteIfaceMQTTTests(IsolatedAsyncioWrapperTestCase):
    ...
    def setUpClass(cls):
        ...
        cls.hbapp = ChimeraBotApplication(client_config_map=cls.client_config_map)
    ...
    @patch('chimerabot.remote_iface.mqtt.MQTTGateway.start')
    ...
    @patch('chimerabot.client.command.mqtt_command.MQTTCommand._mqtt_sleep_rate_autostart_retry', new_callable=PropertyMock)
