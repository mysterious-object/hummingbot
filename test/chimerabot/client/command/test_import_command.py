...
from chimerabot.client.command import import_command
...
from chimerabot.client.config.config_helpers import ClientConfigAdapter, read_system_configs_from_yml, save_to_yml
...
class ImportCommandTest(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("chimerabot.client.config.config_helpers.get_strategy_pydantic_config_cls")
    @patch("chimerabot.client.command.status_command.StatusCommand.status_check_all")
