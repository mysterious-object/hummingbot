...
class ConnectCommandTest(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("chimerabot.client.config.security.Security.update_secure_config")
    @patch("chimerabot.client.config.security.Security.connector_config_file_exists")
    @patch("chimerabot.client.config.security.Security.api_keys")
    @patch("chimerabot.user.user_balances.UserBalances.add_exchange")
    ...
    @patch("chimerabot.user.user_balances.UserBalances.update_exchanges")
    @patch("chimerabot.client.config.security.Security.wait_til_decryption_done")
    ...
    @patch("chimerabot.client.chimerabot_application.ChimeraBotApplication.connection_df")
