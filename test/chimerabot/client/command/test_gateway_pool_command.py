...
class GatewayPoolCommandTest(unittest.TestCase):
    ...
    @patch('chimerabot.core.gateway.gateway_http_client.GatewayHttpClient.get_pool')
    ...
    @patch('chimerabot.core.gateway.gateway_http_client.GatewayHttpClient.get_connector_chain_network')
    @patch('chimerabot.core.gateway.gateway_http_client.GatewayHttpClient.pool_info')
    @patch('chimerabot.core.gateway.gateway_http_client.GatewayHttpClient.add_pool')
    @patch('chimerabot.core.gateway.gateway_http_client.GatewayHttpClient.post_restart')
    ...
    @patch('chimerabot.core.gateway.gateway_http_client.GatewayHttpClient.get_connector_chain_network')
    @patch('chimerabot.core.gateway.gateway_http_client.GatewayHttpClient.pool_info')
    @patch('chimerabot.core.gateway.gateway_http_client.GatewayHttpClient.get_token')
    @patch('chimerabot.core.gateway.gateway_http_client.GatewayHttpClient.add_pool')
    @patch('chimerabot.core.gateway.gateway_http_client.GatewayHttpClient.post_restart')
