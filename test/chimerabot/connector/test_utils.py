...
from chimerabot.client.settings import CONNECTOR_SUBMODULES_THAT_ARE_NOT_CEX_TYPES
from chimerabot.connector.utils import get_new_client_order_id, to_0x_hex
        ...
        for type_dir in type_dirs:
            ...
            for connector_dir in connector_dirs:
                ...
                util_module_path: str = (
                    f"chimerabot.connector.{type_dir.name}.{connector_dir.name}.{connector_dir.name}_utils"
                )
