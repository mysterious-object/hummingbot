...
from chimerabot.client.config.client_config_map import ClientConfigMap, MarketDataCollectionConfigMap
...
from chimerabot.core.data_type.common import OrderType, PositionAction, PriceType, TradeType
...
from chimerabot.model.executors import Executors
from chimerabot.model.market_data import MarketData
...
class MarketsRecorderTests(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("chimerabot.model.sql_connection_manager.create_engine")
    ...
    def test_properties(self):
        ...
        self.assertIsInstance(recorder.logger(), ChimeraBotLogger)
    ...
    @patch("chimerabot.connector.markets_recorder.MarketsRecorder._sleep")
