...
class MexcUserStreamDataSourceUnitTests(IsolatedAsyncioWrapperTestCase):
    ...
    @aioresponses()
    @patch("chimerabot.connector.exchange.mexc.mexc_api_user_stream_data_source.MexcAPIUserStreamDataSource._sleep")
    ...
    @patch("chimerabot.connector.exchange.mexc.mexc_api_user_stream_data_source.MexcAPIUserStreamDataSource"
           "._ping_listen_key",
    ...
    @patch("chimerabot.connector.exchange.mexc.mexc_api_user_stream_data_source.safe_ensure_future")
