...
from chimerabot.connector.exchange.bing_x import bing_x_constants as CONSTANTS, bing_x_web_utils as web_utils
from chimerabot.connector.exchange.bing_x.bing_x_api_order_book_data_source import BingXAPIOrderBookDataSource
from chimerabot.connector.exchange.bing_x.bing_x_exchange import BingXExchange
...
from chimerabot.core.event.events import BuyOrderCreatedEvent, MarketEvent, OrderCancelledEvent
...
class TestBingXExchange(unittest.TestCase):
    ...
    # @patch("chimerabot.connector.exchange.bing_x.bing_x_exchange.BingXExchange._sleep")
