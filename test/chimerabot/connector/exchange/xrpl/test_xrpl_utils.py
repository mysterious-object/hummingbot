...
class TestXRPLUtils(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("chimerabot.connector.exchange.xrpl.xrpl_utils._sleep")
...
class TestXRPLNodePool(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("chimerabot.connector.exchange.xrpl.xrpl_utils.AsyncWebsocketClient")
    ...
    @patch("chimerabot.connector.exchange.xrpl.xrpl_utils.AsyncWebsocketClient")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_utils.XRPLNodePool._get_latency_safe")
