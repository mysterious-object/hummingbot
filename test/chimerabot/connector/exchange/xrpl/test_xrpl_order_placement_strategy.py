...
from chimerabot.connector.exchange.xrpl.xrpl_order_placement_strategy import (
...
class TestXRPLOrderPlacementStrategy(unittest.IsolatedAsyncioTestCase):
    ...
    @patch("chimerabot.connector.exchange.xrpl.xrpl_order_placement_strategy.IssuedCurrencyAmount")
    ...
    @patch("chimerabot.connector.exchange.xrpl.xrpl_order_placement_strategy.Memo")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_order_placement_strategy.convert_string_to_hex")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_order_placement_strategy.OfferCreate")
    ...
    @patch("chimerabot.connector.exchange.xrpl.xrpl_order_placement_strategy.Decimal")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_order_placement_strategy.Memo")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_order_placement_strategy.convert_string_to_hex")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_order_placement_strategy.OfferCreate")
    @patch(
        "chimerabot.connector.exchange.xrpl.xrpl_order_placement_strategy.MarketOrderStrategy.get_base_quote_amounts"
    )
    ...
    @patch("chimerabot.connector.exchange.xrpl.xrpl_order_placement_strategy.Memo")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_order_placement_strategy.convert_string_to_hex")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_order_placement_strategy.Path")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_order_placement_strategy.Payment")
    @patch(
        "chimerabot.connector.exchange.xrpl.xrpl_order_placement_strategy.AMMSwapOrderStrategy.get_base_quote_amounts"
    )
    ...
    @patch("chimerabot.connector.exchange.xrpl.xrpl_order_placement_strategy.LimitOrderStrategy")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_order_placement_strategy.MarketOrderStrategy")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_order_placement_strategy.AMMSwapOrderStrategy")
