...
from chimerabot.connector.exchange.xrpl import xrpl_constants as CONSTANTS
from chimerabot.connector.exchange.xrpl.xrpl_api_order_book_data_source import XRPLAPIOrderBookDataSource
from chimerabot.connector.exchange.xrpl.xrpl_api_user_stream_data_source import XRPLAPIUserStreamDataSource
from chimerabot.connector.exchange.xrpl.xrpl_auth import XRPLAuth
from chimerabot.connector.exchange.xrpl.xrpl_exchange import XrplExchange
from chimerabot.connector.trading_rule import TradingRule
from chimerabot.core.data_type.common import OrderType, TradeType
from chimerabot.core.data_type.in_flight_order import InFlightOrder, OrderState, OrderUpdate, TradeUpdate
from chimerabot.core.data_type.order_book import OrderBook
from chimerabot.core.data_type.order_book_tracker import OrderBookTracker
from chimerabot.core.data_type.trade_fee import AddedToCostTradeFee
from chimerabot.core.data_type.user_stream_tracker import UserStreamTracker
...
class XRPLExchangeUnitTests(IsolatedAsyncioTestCase):
    ...
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.AsyncWebsocketClient")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange._verify_transaction_result")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange.tx_autofill")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange.tx_sign")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange.tx_submit")
    @patch("chimerabot.connector.client_order_tracker.ClientOrderTracker.process_order_update")
    ...
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.autofill", new_callable=MagicMock)
    # @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.submit", new_callable=MagicMock)
    ...
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.AsyncWebsocketClient")
    @patch("chimerabot.connector.exchange_py_base.ExchangePyBase._sleep")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange._verify_transaction_result")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange.tx_autofill")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange.tx_sign")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange.tx_submit")
    @patch("chimerabot.connector.client_order_tracker.ClientOrderTracker.process_order_update")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange._make_network_check_request")
    ...
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange.tx_submit")
    @patch("chimerabot.connector.client_order_tracker.ClientOrderTracker.process_order_update")
    @patch("chimerabot.connector.client_order_tracker.ClientOrderTracker.process_trade_update")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange.process_trade_fills")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange._request_order_status")
    ...
    @patch("chimerabot.connector.exchange_py_base.ExchangePyBase._iter_user_event_queue")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange.get_order_by_sequence")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_auth.XRPLAuth.get_account")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange._update_balances")
    @patch("chimerabot.connector.client_order_tracker.ClientOrderTracker.process_order_update")
    ...
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange.wait_for_final_transaction_outcome")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange._make_network_check_request")
    ...
    async def test_verify_transaction_exception(self, network_check_mock, wait_for_outcome_mock):
        ...
        self.assertIn(
            "ERROR:chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange:Submitted transaction failed: Test exception",
            log_output,
        )
    ...
    async def test_verify_transaction_exception_none_transaction(self):
        ...
        self.assertEqual(
            log_output,
            "ERROR:chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange:Failed to verify transaction result, transaction is None",
        )
        ...
        log_output = log.output[0]
        self.assertIn(
            "ERROR:chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange:Max retries reached. Verify transaction failed due to timeout",
            log_output
        )
    ...
    async def test_verify_transaction_exception_none_prelim(self, network_check_mock, wait_for_outcome_mock):
        ...
        self.assertEqual(
            log_output,
            "ERROR:chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange:Failed to verify transaction result, prelim_result is None",
        )
    ...
    @patch("chimerabot.connector.exchange.xrpl.xrpl_auth.XRPLAuth.get_account")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange._make_network_check_request")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange._fetch_account_transactions")
    ...
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange._make_network_check_request")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange._fetch_account_transactions")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.get_token_from_changes")
    ...
    @patch("chimerabot.connector.exchange.xrpl.xrpl_auth.XRPLAuth.get_account")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange.request_with_retry")
    ...
    async def test_order_status_determination(
        ...
        with patch(
            "chimerabot.connector.exchange.xrpl.xrpl_exchange.get_order_book_changes"
        ) as mock_order_book_changes:
            with patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.get_balance_changes") as mock_balance_changes:
                # Configure mocks
    ...
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange._request_order_status")
    @patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.XrplExchange._all_trade_updates_for_order")
        ...
        with patch.object(self.connector, "_request_order_status") as status_mock:
            with patch.object(self.connector, "_place_cancel") as place_cancel_mock:
                with patch.object(self.connector, "_verify_transaction_result") as verify_mock:
                    with patch("chimerabot.connector.exchange.xrpl.xrpl_exchange.get_order_book_changes") as book_changes_mock:
