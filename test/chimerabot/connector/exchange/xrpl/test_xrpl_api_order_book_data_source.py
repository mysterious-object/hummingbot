...
class XRPLAPIOrderBookDataSourceUnitTests(IsolatedAsyncioWrapperTestCase):
    ...
    @patch(
        "chimerabot.connector.exchange.xrpl.xrpl_api_order_book_data_source.XRPLAPIOrderBookDataSource._request_order_book_snapshot"
    )
    ...
    @patch(
        "chimerabot.connector.exchange.xrpl.xrpl_api_order_book_data_source.XRPLAPIOrderBookDataSource.get_last_traded_prices"
    )
