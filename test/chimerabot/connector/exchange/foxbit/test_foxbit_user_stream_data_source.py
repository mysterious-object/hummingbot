...
from chimerabot.connector.exchange.foxbit import foxbit_constants as CONSTANTS
...
@patch("chimerabot.connector.exchange.foxbit.foxbit_api_user_stream_data_source.FoxbitAPIUserStreamDataSource._sleep", new_callable=AsyncMock)
class FoxbitUserStreamDataSourceUnitTests(unittest.TestCase):
    ...
    @patch("chimerabot.connector.exchange.foxbit.foxbit_api_user_stream_data_source.web_utils.websocket_url", return_value="wss://test")
    @patch("chimerabot.connector.exchange.foxbit.foxbit_api_user_stream_data_source.WSAssistant")
