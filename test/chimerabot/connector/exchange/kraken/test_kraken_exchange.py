...
from chimerabot.connector.exchange.kraken.kraken_exchange import KrakenExchange
...
class KrakenExchangeTests(AbstractExchangeConnectorTests.ExchangeConnectorTests):
    ...
    @patch("chimerabot.connector.exchange.kraken.kraken_exchange.get_new_numeric_client_order_id")
    ...
    @aioresponses()
    @patch("chimerabot.connector.exchange.kraken.kraken_exchange.KrakenExchange.exchange_symbol_associated_to_pair")
    ...
    async def test_get_ticker_data(self, mock_api):
        ...
        with patch("chimerabot.connector.exchange.kraken.kraken_exchange.KrakenExchange.exchange_symbol_associated_to_pair",
