...
from chimerabot.connector.exchange.kraken.kraken_utils import build_rate_limits_by_tier
...
from chimerabot.core.data_type.order_book import OrderBook, OrderBookMessage
...
class KrakenAPIOrderBookDataSourceTest(IsolatedAsyncioWrapperTestCase):
    ...
    @aioresponses()
    @patch("chimerabot.connector.exchange.kraken.kraken_api_order_book_data_source"
