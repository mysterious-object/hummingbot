...
from chimerabot.connector.exchange.htx.htx_web_utils import build_api_factory
...
class HtxAPIOrderBookDataSourceUnitTests(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("aiohttp.ClientSession.ws_connect", new_callable=AsyncMock)
    @patch("chimerabot.connector.exchange.htx.htx_api_order_book_data_source.HtxAPIOrderBookDataSource._sleep")
