...
from chimerabot.connector.exchange.vertex import vertex_constants as CONSTANTS, vertex_web_utils as web_utils
from chimerabot.connector.exchange.vertex.vertex_api_order_book_data_source import VertexAPIOrderBookDataSource
from chimerabot.connector.exchange.vertex.vertex_exchange import VertexExchange
...
class TestVertexExchange(unittest.TestCase):
    ...
    @aioresponses()
    @patch("chimerabot.connector.exchange.vertex.vertex_exchange.VertexExchange.get_price")
