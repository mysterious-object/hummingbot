...
class TestVertexAPIUserStreamDataSource(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("chimerabot.connector.exchange.vertex.vertex_auth.VertexAuth._time")
    @patch("aiohttp.ClientSession.ws_connect", new_callable=AsyncMock)
    ...
    @patch("aiohttp.ClientSession.ws_connect", new_callable=AsyncMock)
    @patch(
        "chimerabot.connector.exchange.vertex.vertex_api_user_stream_data_source.VertexAPIUserStreamDataSource" "._time"
    )
