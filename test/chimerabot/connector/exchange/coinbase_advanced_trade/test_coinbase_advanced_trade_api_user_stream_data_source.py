...
from chimerabot.connector.exchange.coinbase_advanced_trade import coinbase_advanced_trade_constants as CONSTANTS
...
from chimerabot.core.web_assistant.connections.data_types import WSRequest, WSResponse
...
class CoinbaseAdvancedTradeAPIUserStreamDataSourceTests(
    ...
    async def test_decipher_message(self):
        ...
        with patch('chimerabot.connector.exchange.coinbase_advanced_trade'
