...
class CoinbaseAdvancedTradeUtilTestCases(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("chimerabot.connector.exchange.coinbase_advanced_trade.coinbase_advanced_trade_web_utils"
    ...
    @patch(
        'chimerabot.connector.exchange.coinbase_advanced_trade.coinbase_advanced_trade_web_utils'
        '.build_api_factory_without_time_synchronizer_pre_processor',
        new_callable=Mock)
    @patch('chimerabot.connector.exchange.coinbase_advanced_trade.coinbase_advanced_trade_web_utils'
           '.private_rest_url')
