...
from chimerabot.core.web_assistant.connections.data_types import RESTMethod, RESTRequest, WSJSONRequest
...
class CoinbaseAdvancedTradeAuthTests(IsolatedAsyncioWrapperTestCase):
    ...
    async def test_rest_legacy_authenticate_on_public_time(self):
        ...
        with patch('chimerabot.connector.exchange.coinbase_advanced_trade.coinbase_advanced_trade_web_utils'
