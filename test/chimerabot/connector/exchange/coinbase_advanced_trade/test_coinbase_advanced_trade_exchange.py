...
from chimerabot.connector.exchange.coinbase_advanced_trade import (
...
from chimerabot.connector.exchange.coinbase_advanced_trade.coinbase_advanced_trade_exchange import (
...
from chimerabot.connector.test_support.exchange_connector_test import AbstractExchangeConnectorTests
...
from chimerabot.core.data_type.in_flight_order import InFlightOrder, OrderState, OrderUpdate
...
class CoinbaseAdvancedTradeExchangeTests(AbstractExchangeConnectorTests.ExchangeConnectorTests, LoggerMixinForTest):
    ...
    def test_update_order_fills_request_parameters(self, mock_api):
        ...
        with patch("chimerabot.connector.exchange.coinbase_advanced_trade.coinbase_advanced_trade_exchange"
                   ".set_exchange_time_from_timestamp",
    ...
    @aioresponses()
    @patch("chimerabot.core.utils.trading_pair_fetcher.TradingPairFetcher.fetch_all", new_callable=AsyncMock())
