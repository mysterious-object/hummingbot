...
from chimerabot.connector.exchange.derive import derive_constants as CONSTANTS
...
from chimerabot.connector.exchange.derive.derive_exchange import DeriveExchange
...
class TestDeriveAPIUserStreamDataSource(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("chimerabot.connector.exchange.derive.derive_auth.DeriveAuth.get_ws_auth_payload")
    @patch("chimerabot.connector.exchange.derive.derive_api_user_stream_data_source.DeriveAPIUserStreamDataSource._time")
    @patch("chimerabot.connector.exchange.derive.derive_web_utils.utc_now_ms")
