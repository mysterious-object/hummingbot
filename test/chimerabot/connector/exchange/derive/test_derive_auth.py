...
class DeriveAuthTests(TestCase):
    ...
    @patch("chimerabot.connector.exchange.derive.derive_auth.DeriveAuth.utc_now_ms")
    ...
    @patch("chimerabot.connector.exchange.derive.derive_auth.DeriveAuth.header_for_authentication")
    ...
    def test_add_auth_to_params_post(self):
        ...
        with patch("chimerabot.connector.exchange.derive.derive_auth.SignedAction.sign") as mock_sign, \
                patch("chimerabot.connector.exchange.derive.derive_web_utils.order_to_call") as mock_order_to_call:
