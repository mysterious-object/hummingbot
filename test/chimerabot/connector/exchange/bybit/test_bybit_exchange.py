...
from chimerabot.connector.exchange.bybit import bybit_constants as CONSTANTS, bybit_web_utils as web_utils
from chimerabot.connector.exchange.bybit.bybit_api_order_book_data_source import BybitAPIOrderBookDataSource
from chimerabot.connector.exchange.bybit.bybit_exchange import BybitExchange
...
class TestBybitExchange(unittest.TestCase):
    ...
    @aioresponses()
    @patch("chimerabot.connector.exchange.bybit.bybit_exchange.BybitExchange.get_price")
