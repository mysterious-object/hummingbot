...
class TestBybitAPIUserStreamDataSource(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("chimerabot.connector.exchange.bybit.bybit_auth.BybitAuth._time")
    ...
    @patch("aiohttp.ClientSession.ws_connect", new_callable=AsyncMock)
    @patch("chimerabot.connector.exchange.bybit.bybit_api_user_stream_data_source.BybitAPIUserStreamDataSource._time")
