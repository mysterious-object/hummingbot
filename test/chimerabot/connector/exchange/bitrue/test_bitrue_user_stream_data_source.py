...
from chimerabot.connector.exchange.bitrue import bitrue_constants as CONSTANTS
...
class BitrueUserStreamDataSourceUnitTests(IsolatedAsyncioWrapperTestCase):
    ...
    @patch(
        "chimerabot.connector.exchange.bitrue.bitrue_user_stream_data_source.BitrueUserStreamDataSource"
        "._ping_listen_key",
    ...
    @patch("chimerabot.connector.exchange.bitrue.bitrue_user_stream_data_source.safe_ensure_future")
