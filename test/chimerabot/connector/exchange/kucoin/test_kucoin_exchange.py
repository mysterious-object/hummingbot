...
from chimerabot.connector.exchange.kucoin import kucoin_constants as CONSTANTS, kucoin_web_utils as web_utils
from chimerabot.connector.exchange.kucoin.kucoin_exchange import KucoinExchange
...
from chimerabot.core.data_type.in_flight_order import InFlightOrder, OrderState, TradeUpdate
...
class KucoinExchangeTests(unittest.TestCase):
    ...
    @aioresponses()
    @patch("chimerabot.connector.exchange.kucoin.kucoin_exchange.KucoinExchange.get_price")
    ...
    @patch("chimerabot.connector.exchange.kucoin.kucoin_exchange.KucoinExchange._sleep")
