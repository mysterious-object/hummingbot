...
class TestKucoinAPIOrderBookDataSource(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("chimerabot.connector.exchange.kucoin.kucoin_web_utils.next_message_id")
    ...
    @patch("aiohttp.ClientSession.ws_connect", new_callable=AsyncMock)
    @patch("chimerabot.connector.exchange.kucoin.kucoin_web_utils.next_message_id")
    @patch("chimerabot.connector.exchange.kucoin.kucoin_api_order_book_data_source.KucoinAPIOrderBookDataSource._time")
    ...
    @aioresponses()
    @patch("chimerabot.connector.exchange.kucoin.kucoin_api_order_book_data_source"
