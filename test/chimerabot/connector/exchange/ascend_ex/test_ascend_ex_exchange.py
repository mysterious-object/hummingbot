...
from chimerabot.connector.exchange.ascend_ex import ascend_ex_constants as CONSTANTS, ascend_ex_web_utils as web_utils
from chimerabot.connector.exchange.ascend_ex.ascend_ex_exchange import AscendExExchange
...
from chimerabot.core.data_type.in_flight_order import InFlightOrder, TradeUpdate
from chimerabot.core.data_type.trade_fee import AddedToCostTradeFee, TokenAmount, TradeFeeBase
from chimerabot.core.event.events import BuyOrderCompletedEvent, MarketOrderFailureEvent, OrderFilledEvent
...
class AscendExExchangeTests(AbstractExchangeConnectorTests.ExchangeConnectorTests):
    ...
    @aioresponses()
    @patch("chimerabot.connector.exchange.ascend_ex.ascend_ex_exchange.AscendExExchange.get_price")
