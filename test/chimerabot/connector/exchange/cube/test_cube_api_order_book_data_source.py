...
from chimerabot.connector.exchange.cube import cube_constants as CONSTANTS, cube_web_utils as web_utils
from chimerabot.connector.exchange.cube.cube_api_order_book_data_source import CubeAPIOrderBookDataSource
from chimerabot.connector.exchange.cube.cube_exchange import CubeExchange
from chimerabot.connector.exchange.cube.cube_ws_protobufs import market_data_pb2, trade_pb2
...
class CubeAPIOrderBookDataSourceUnitTests(IsolatedAsyncioWrapperTestCase):
    ...
    @aioresponses()
    @patch(
        "chimerabot.connector.exchange.cube.cube_api_order_book_data_source"
