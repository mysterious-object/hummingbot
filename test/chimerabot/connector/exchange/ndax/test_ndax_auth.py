...
from chimerabot.connector.exchange.ndax import ndax_web_utils as web_utils
...
class NdaxAuthTests(TestCase):
    ...
    def test_header_for_authentication(self):
        ...
        with patch('chimerabot.connector.exchange.ndax.ndax_auth.get_tracking_nonce_low_res') as generate_nonce_mock:
