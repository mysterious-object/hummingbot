...
from chimerabot.connector.exchange.bitstamp import bitstamp_web_utils as web_utils
from chimerabot.connector.exchange.bitstamp.bitstamp_web_utils import BitstampRESTPreProcessor
...
class BitstampWebUtilsTests(TestCase):
    ...
    @patch('chimerabot.connector.exchange.bitstamp.bitstamp_web_utils'
