...
from chimerabot.connector.exchange.bitstamp.bitstamp_utils import DEFAULT_FEES
...
from chimerabot.core.data_type.trade_fee import AddedToCostTradeFee, TokenAmount, TradeFeeBase, TradeFeeSchema
