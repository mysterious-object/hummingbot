...
from chimerabot.connector.exchange.btc_markets import btc_markets_constants as CONSTANTS
...
from chimerabot.connector.exchange.btc_markets.btc_markets_exchange import BtcMarketsExchange
...
class BtcMarketsAPIUserStreamDataSourceTest(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("chimerabot.connector.exchange.btc_markets.btc_markets_auth.BtcMarketsAuth._time")
    @patch("aiohttp.ClientSession.ws_connect", new_callable=AsyncMock)
