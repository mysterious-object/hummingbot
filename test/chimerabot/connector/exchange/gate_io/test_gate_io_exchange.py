...
from chimerabot.connector.exchange.gate_io import gate_io_constants as CONSTANTS
from chimerabot.connector.exchange.gate_io.gate_io_exchange import GateIoExchange
...
from chimerabot.connector.utils import get_new_client_order_id
from chimerabot.core.data_type.cancellation_result import CancellationResult
from chimerabot.core.data_type.common import OrderType, PositionAction, TradeType
...
from chimerabot.core.data_type.order_book_row import OrderBookRow
from chimerabot.core.data_type.trade_fee import TokenAmount
...
class TestGateIoExchange(IsolatedAsyncioWrapperTestCase):
    ...
    @aioresponses()
    @patch("chimerabot.connector.exchange.gate_io.gate_io_exchange.GateIoExchange.get_price")
    ...
    @aioresponses()
    @patch("chimerabot.connector.exchange.gate_io.gate_io_exchange.GateIoExchange.get_price")
    @patch("chimerabot.connector.exchange.gate_io.gate_io_exchange.GateIoExchange.get_price_for_volume")
    ...
    @patch("chimerabot.client.chimerabot_application.ChimeraBotApplication")
    @aioresponses()
    ...
    @patch("chimerabot.connector.utils.get_tracking_nonce")
    ...
    @patch("chimerabot.connector.exchange.gate_io.gate_io_exchange.GateIoExchange._sleep")
