...
from chimerabot.connector.exchange_base import bidict
...
class DexalotClientTests(TestCase):
    ...
    @patch(
        "chimerabot.connector.exchange.dexalot.data_sources.dexalot_data_source.DexalotClient._build_and_send_tx")
    ...
    @patch("chimerabot.connector.exchange.dexalot.data_sources.dexalot_data_source.DexalotClient._build_and_send_tx")
