...
class BinanceUserStreamDataSourceUnitTests(IsolatedAsyncioWrapperTestCase):
    ...
    @aioresponses()
    @patch("chimerabot.connector.exchange.binance.binance_api_user_stream_data_source.BinanceAPIUserStreamDataSource._sleep")
    ...
    @patch("chimerabot.connector.exchange.binance.binance_api_user_stream_data_source.BinanceAPIUserStreamDataSource"
           "._ping_listen_key",
    ...
    @patch("chimerabot.connector.exchange.binance.binance_api_user_stream_data_source.safe_ensure_future")
