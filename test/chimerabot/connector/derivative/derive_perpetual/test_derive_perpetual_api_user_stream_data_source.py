...
from chimerabot.connector.derivative.derive_perpetual import derive_perpetual_constants as CONSTANTS
...
class TestDerivePerpetualAPIUserStreamDataSource(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("chimerabot.connector.derivative.derive_perpetual.derive_perpetual_auth.DerivePerpetualAuth.get_ws_auth_payload")
    @patch("chimerabot.connector.derivative.derive_perpetual.derive_perpetual_api_user_stream_data_source.DerivePerpetualAPIUserStreamDataSource._time")
    @patch("chimerabot.connector.derivative.derive_perpetual.derive_perpetual_web_utils.utc_now_ms")
    ...
    @patch("aiohttp.ClientSession.ws_connect", new_callable=AsyncMock)
    @patch("chimerabot.core.data_type.user_stream_tracker_data_source.UserStreamTrackerDataSource._sleep")
