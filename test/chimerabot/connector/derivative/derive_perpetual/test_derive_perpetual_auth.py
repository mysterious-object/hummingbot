...
from chimerabot.core.web_assistant.connections.data_types import RESTMethod, RESTRequest, WSRequest
...
class DerivePerpetualAuthTests(TestCase):
    ...
    @patch("chimerabot.connector.derivative.derive_perpetual.derive_perpetual_auth.DerivePerpetualAuth.utc_now_ms")
    ...
    @patch("chimerabot.core.web_assistant.connections.data_types.WSRequest.send_with_connection")
    ...
    @patch("chimerabot.connector.derivative.derive_perpetual.derive_perpetual_auth.DerivePerpetualAuth.header_for_authentication")
    ...
    def test_add_auth_to_params_post(self):
        ...
        with patch("chimerabot.connector.derivative.derive_perpetual.derive_perpetual_auth.SignedAction.sign") as mock_sign, \
                patch("chimerabot.connector.derivative.derive_perpetual.derive_perpetual_web_utils.order_to_call") as mock_order_to_call:
