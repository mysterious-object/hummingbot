...
import chimerabot.connector.derivative.binance_perpetual.binance_perpetual_constants as CONSTANTS
import chimerabot.connector.derivative.binance_perpetual.binance_perpetual_web_utils as web_utils
from chimerabot.connector.derivative.binance_perpetual.binance_perpetual_api_order_book_data_source import (
    BinancePerpetualAPIOrderBookDataSource,
)
from chimerabot.connector.derivative.binance_perpetual.binance_perpetual_derivative import BinancePerpetualDerivative
...
class BinancePerpetualDerivativeUnitTest(IsolatedAsyncioWrapperTestCase):
    ...
    @aioresponses()
    @patch("chimerabot.connector.derivative.binance_perpetual.binance_perpetual_derivative."
    ...
    @aioresponses()
    @patch("chimerabot.connector.derivative.binance_perpetual.binance_perpetual_web_utils.get_current_server_time")
