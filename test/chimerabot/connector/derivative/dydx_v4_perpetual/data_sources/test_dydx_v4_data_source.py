...
from chimerabot.connector.derivative.dydx_v4_perpetual import dydx_v4_perpetual_constants as CONSTANTS
...
class DydxPerpetualV4ClientTests(IsolatedAsyncioWrapperTestCase):
    ...
    @patch(
        "chimerabot.connector.derivative.dydx_v4_perpetual.data_sources.dydx_v4_data_source.DydxPerpetualV4Client.send_tx_sync_mode")
