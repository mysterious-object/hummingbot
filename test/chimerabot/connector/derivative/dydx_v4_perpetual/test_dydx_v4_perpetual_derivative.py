...
from test.chimerabot.connector.derivative.dydx_v4_perpetual.programmable_v4_client import ProgrammableV4Client
...
import chimerabot.connector.derivative.dydx_v4_perpetual.dydx_v4_perpetual_web_utils as web_utils
from chimerabot.connector.derivative.dydx_v4_perpetual.dydx_v4_perpetual_derivative import DydxV4PerpetualDerivative
...
class DydxV4PerpetualDerivativeTests(AbstractPerpetualDerivativeTests.PerpetualDerivativeTests):
    ...
    @patch("chimerabot.connector.derivative.dydx_v4_perpetual.dydx_v4_perpetual_api_order_book_data_source."
