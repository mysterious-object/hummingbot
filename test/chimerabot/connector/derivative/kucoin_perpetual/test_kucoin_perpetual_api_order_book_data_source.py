...
import chimerabot.connector.derivative.kucoin_perpetual.kucoin_perpetual_web_utils as web_utils
...
from chimerabot.connector.derivative.kucoin_perpetual import kucoin_perpetual_constants as CONSTANTS
from chimerabot.connector.derivative.kucoin_perpetual.kucoin_perpetual_api_order_book_data_source import (
    KucoinPerpetualAPIOrderBookDataSource,
)
from chimerabot.connector.derivative.kucoin_perpetual.kucoin_perpetual_derivative import KucoinPerpetualDerivative
...
from chimerabot.core.web_assistant.connections.connections_factory import ConnectionsFactory

os.environ['PYTHONASYNCIODEBUG'] = '1'


class KucoinPerpetualAPIOrderBookDataSourceTests(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("chimerabot.connector.derivative.kucoin_perpetual.kucoin_perpetual_web_utils.next_message_id")
    ...
    async def test_listen_for_subscriptions_logs_exception_details(self, mock_api, _, ws_connect_mock):
        url = web_utils.get_rest_url_for_endpoint(endpoint=CONSTANTS.PUBLIC_WS_DATA_PATH_URL)
    ...
    @aioresponses()
    @patch("chimerabot.connector.derivative.kucoin_perpetual.kucoin_perpetual_api_order_book_data_source"
