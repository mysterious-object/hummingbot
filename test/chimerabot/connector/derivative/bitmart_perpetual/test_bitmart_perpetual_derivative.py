...
import chimerabot.connector.derivative.bitmart_perpetual.bitmart_perpetual_constants as CONSTANTS
import chimerabot.connector.derivative.bitmart_perpetual.bitmart_perpetual_web_utils as web_utils
from chimerabot.connector.derivative.bitmart_perpetual.bitmart_perpetual_api_order_book_data_source import (
    BitmartPerpetualAPIOrderBookDataSource,
)
from chimerabot.connector.derivative.bitmart_perpetual.bitmart_perpetual_derivative import BitmartPerpetualDerivative
...
class BitmartPerpetualDerivativeUnitTest(IsolatedAsyncioWrapperTestCase):
    ...
    @aioresponses()
    @patch("chimerabot.connector.derivative.bitmart_perpetual.bitmart_perpetual_derivative.BitmartPerpetualDerivative.get_price_by_type")
    ...
    @aioresponses()
    @patch("chimerabot.connector.derivative.bitmart_perpetual.bitmart_perpetual_derivative."
