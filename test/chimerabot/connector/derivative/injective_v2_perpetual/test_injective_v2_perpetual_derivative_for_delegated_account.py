...
from test.chimerabot.connector.exchange.injective_v2.programmable_query_executor import ProgrammableQueryExecutor
...
from chimerabot.connector.derivative.injective_v2_perpetual.injective_v2_perpetual_derivative import (
    InjectiveV2PerpetualDerivative,
)
from chimerabot.connector.exchange.injective_v2.injective_v2_utils import (
    InjectiveConfigMap,
...
class InjectiveV2PerpetualDerivativeTests(AbstractPerpetualDerivativeTests.PerpetualDerivativeTests):
    ...
    def setUp(self) -> None:
        self._initialize_timeout_height_sync_task = patch(
            "chimerabot.connector.exchange.injective_v2.data_sources.injective_grantee_data_source"
    ...
    # @patch("chimerabot.connector.exchange.injective_v2.data_sources.injective_data_source.InjectiveDataSource._time")
