...
from chimerabot.connector.exchange.injective_v2.injective_market import InjectiveToken
...
class InjectiveV2APIOrderBookDataSourceTests(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("chimerabot.core.utils.trading_pair_fetcher.TradingPairFetcher.fetch_all")
    ...
    @patch(
        "chimerabot.connector.exchange.injective_v2.data_sources.injective_grantee_data_source.InjectiveGranteeDataSource._initialize_timeout_height")
