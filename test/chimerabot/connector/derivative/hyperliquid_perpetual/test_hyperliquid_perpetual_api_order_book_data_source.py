...
import chimerabot.connector.derivative.hyperliquid_perpetual.hyperliquid_perpetual_web_utils as web_utils
...
from chimerabot.connector.derivative.hyperliquid_perpetual import hyperliquid_perpetual_constants as CONSTANTS
from chimerabot.connector.derivative.hyperliquid_perpetual.hyperliquid_perpetual_api_order_book_data_source import (
    HyperliquidPerpetualAPIOrderBookDataSource,
)
from chimerabot.connector.derivative.hyperliquid_perpetual.hyperliquid_perpetual_derivative import (
...
class HyperliquidPerpetualAPIOrderBookDataSourceTests(IsolatedAsyncioWrapperTestCase):
    ...
    @patch(
        "chimerabot.connector.derivative.hyperliquid_perpetual.hyperliquid_perpetual_api_order_book_data_source."
    ...
    @aioresponses()
    @patch("chimerabot.connector.derivative.hyperliquid_perpetual.hyperliquid_perpetual_api_order_book_data_source.HyperliquidPerpetualAPIOrderBookDataSource._next_funding_time")
