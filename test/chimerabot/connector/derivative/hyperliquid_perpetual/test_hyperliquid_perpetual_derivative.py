...
import chimerabot.connector.derivative.hyperliquid_perpetual.hyperliquid_perpetual_constants as CONSTANTS
...
class HyperliquidPerpetualDerivativeTests(AbstractPerpetualDerivativeTests.PerpetualDerivativeTests):
    ...
    @patch(
        "chimerabot.connector.derivative.hyperliquid_perpetual.hyperliquid_perpetual_api_order_book_data_source.HyperliquidPerpetualAPIOrderBookDataSource._next_funding_time")
    ...
    def test_update_positions_short_position(self, mock_api):
        ...
        from chimerabot.core.data_type.common import PositionSide
