...
import chimerabot.connector.connector_metrics_collector
from chimerabot.connector.connector_metrics_collector import TradeVolumeMetricCollector
...
class TradeVolumeMetricCollectorTests(TestCase):
    ...
    def setUp(self) -> None:
        ...
        self.original_client_version = chimerabot.connector.connector_metrics_collector.CLIENT_VERSION
        chimerabot.connector.connector_metrics_collector.CLIENT_VERSION = self.client_version
    ...
    def tearDown(self) -> None:
        chimerabot.connector.connector_metrics_collector.CLIENT_VERSION = self.original_client_version
        super().tearDown()
