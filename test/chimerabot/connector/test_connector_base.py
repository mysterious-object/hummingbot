...
from chimerabot.connector.connector_base import ConnectorBase, OrderFilledEvent
...
class ConnectorBaseUnitTest(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        cls._patcher = unittest.mock.patch("chimerabot.connector.connector_base.estimate_fee")
