...
from chimerabot.connector.gateway.gateway_lp import (
    AMMPoolInfo,
    AMMPositionInfo,
    CLMMPoolInfo,
    CLMMPositionInfo,
...
class GatewayLpTest(unittest.TestCase):
    ...
    @patch('chimerabot.connector.gateway.gateway_lp.get_connector_type')
    ...
    def test_add_liquidity_amm(self):
        ...
        with patch('chimerabot.connector.gateway.gateway_lp.get_connector_type') as mock_connector_type:
            mock_connector_type.return_value = ConnectorType.AMM

            with patch('chimerabot.connector.gateway.gateway_lp.safe_ensure_future') as mock_ensure_future:
