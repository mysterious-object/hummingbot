...
from chimerabot.core.event.events import BuyOrderCompletedEvent, MarketOrderFailureEvent, OrderCancelledEvent
...
class TestPositionExecutor(IsolatedAsyncioWrapperTestCase):
    ...
    def test_properties(self):
        ...
        self.assertIsInstance(position_executor.logger(), ChimeraBotLogger)
    ...
    @patch.object(PositionExecutor, "get_trading_rules")
    @patch("chimerabot.strategy_v2.executors.position_executor.position_executor.PositionExecutor.get_price",
