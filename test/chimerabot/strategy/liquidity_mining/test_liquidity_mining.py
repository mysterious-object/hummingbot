...
from chimerabot.connector.exchange.paper_trade.paper_trade_exchange import QuantizationParams
...
from chimerabot.core.data_type.trade_fee import AddedToCostTradeFee, TokenAmount
from chimerabot.core.event.event_logger import EventLogger
from chimerabot.core.event.events import MarketEvent, OrderBookTradeEvent
from chimerabot.strategy.liquidity_mining.data_types import PriceSize, Proposal
from chimerabot.strategy.liquidity_mining.liquidity_mining import LiquidityMiningStrategy
...
class LiquidityMiningTest(unittest.TestCase):
    ...
    @unittest.mock.patch('chimerabot.strategy.liquidity_mining.liquidity_mining.build_trade_fee')
    ...
    @unittest.mock.patch('chimerabot.strategy.liquidity_mining.liquidity_mining.MarketTradingPairTuple.get_mid_price')
    @unittest.mock.patch('chimerabot.strategy.liquidity_mining.liquidity_mining.build_trade_fee')
    ...
    @unittest.mock.patch('chimerabot.client.chimerabot_application.ChimeraBotApplication.main_application')
    @unittest.mock.patch('chimerabot.client.chimerabot_application.ChimeraBotCLI')
    def test_strategy_with_default_cfg_does_not_send_in_app_notifications(self, cli_class_mock,
        ...
        chimerabot_application = ChimeraBotApplication()
        chimerabot_application.notifiers.append(notifier_mock)
        main_application_function_mock.return_value = chimerabot_application
