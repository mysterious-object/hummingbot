...
from chimerabot.client.config.config_helpers import ClientConfigAdapter, ConfigValidationError
...
class CrossExchangeMarketMakingConfigMapPydanticTest(unittest.TestCase):
    ...
    def setUp(self) -> None:
        ...
        self._get_exchange_names_patcher = patch("chimerabot.client.settings.AllConnectorSettings.get_exchange_names")
        self._get_connector_settings_patcher = patch(
            "chimerabot.client.settings.AllConnectorSettings.get_connector_settings")
    ...
    @patch("chimerabot.client.config.strategy_config_data_types.validate_market_trading_pair")
