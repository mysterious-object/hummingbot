...
from chimerabot.client.settings import ConnectorSetting, ConnectorType
...
from chimerabot.strategy.cross_exchange_market_making.cross_exchange_market_making import (
    CrossExchangeMarketMakingStrategy,
    LogOption,
)
from chimerabot.strategy.cross_exchange_market_making.cross_exchange_market_making_config_map_pydantic import (
...
class HedgedMarketMakingUnitTest(unittest.TestCase):
    ...
    @patch("chimerabot.client.settings.AllConnectorSettings.get_exchange_names")
    @patch("chimerabot.client.settings.AllConnectorSettings.get_connector_settings")
    ...
    @patch("chimerabot.client.settings.AllConnectorSettings.get_exchange_names")
    @patch("chimerabot.client.settings.AllConnectorSettings.get_connector_settings")
    @patch('chimerabot.strategy.cross_exchange_market_making.cross_exchange_market_making.'
