...
class DirectionalStrategyBaseTest(unittest.TestCase):
    ...
    @patch("chimerabot.strategy.directional_strategy_base.DirectionalStrategyBase.get_signal")
    ...
    @patch("chimerabot.strategy.directional_strategy_base.DirectionalStrategyBase.get_signal", new_callable=MagicMock)
