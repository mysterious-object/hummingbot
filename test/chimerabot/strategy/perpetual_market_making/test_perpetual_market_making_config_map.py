...
import chimerabot.strategy.perpetual_market_making.perpetual_market_making_config_map as config_map_module
...
class TestPMMConfigMap(unittest.TestCase):
    ...
    @patch("chimerabot.client.settings.AllConnectorSettings.get_derivative_names")
