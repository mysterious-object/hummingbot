...
from chimerabot.core.clock_mode import ClockMode
from chimerabot.core.data_type.common import OrderType, PositionMode, PositionSide, PriceType, TradeType
...
class PerpetualMarketMakingTests(TestCase):
    ...
    @patch("chimerabot.connector.perpetual_trading.PerpetualTrading.set_position_mode")
