...
from chimerabot.core.utils.fixed_rate_source import FixedRateSource
from chimerabot.strategy.amm_arb.data_types import ArbProposal, ArbProposalSide, TokenAmount
...
class ArbProposalTests(TestCase):
    ...
    @patch("chimerabot.client.config.trade_fee_schema_loader.TradeFeeSchemaLoader.configured_schema_for_exchange",
