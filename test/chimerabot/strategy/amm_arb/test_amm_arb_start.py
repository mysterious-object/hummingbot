...
from test.chimerabot.strategy import assign_config_default
from test.isolated_asyncio_wrapper_test_case import IsolatedAsyncioWrapperTestCase

import chimerabot.strategy.amm_arb.start as amm_arb_start
from chimerabot.strategy.amm_arb.amm_arb import AmmArbStrategy
from chimerabot.strategy.amm_arb.amm_arb_config_map import amm_arb_config_map
...
class AMMArbStartTest(IsolatedAsyncioWrapperTestCase):
    ...
    @unittest.mock.patch('chimerabot.strategy.amm_arb.amm_arb.AmmArbStrategy.add_markets')
