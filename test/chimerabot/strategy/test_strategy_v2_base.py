...
from chimerabot.strategy_v2.models.executor_actions import CreateExecutorAction
...
class TestStrategyV2Base(IsolatedAsyncioWrapperTestCase):
    def setUp(self):
        ...
        with patch('asyncio.create_task', return_value=MagicMock()):
            ...
            with patch("chimerabot.strategy.strategy_v2_base.StrategyV2Base.listen_to_executor_actions", return_value=AsyncMock()):
                with patch('chimerabot.strategy.strategy_v2_base.ExecutorOrchestrator') as MockExecutorOrchestrator:
                    with patch('chimerabot.strategy.strategy_v2_base.MarketDataProvider') as MockMarketDataProvider:
    ...
    @patch("chimerabot.data_feed.market_data_provider.MarketDataProvider.ready", new_callable=PropertyMock)
    @patch("chimerabot.strategy_v2.executors.executor_orchestrator.ExecutorOrchestrator.execute_action")
