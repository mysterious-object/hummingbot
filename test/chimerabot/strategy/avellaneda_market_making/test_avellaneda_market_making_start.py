...
import chimerabot.strategy.avellaneda_market_making.start as strategy_start
...
class AvellanedaStartTest(IsolatedAsyncioWrapperTestCase):
    ...
    @unittest.mock.patch('chimerabot.strategy.avellaneda_market_making.start.ChimeraBotApplication')
