...
from chimerabot.core.data_type.order_book_query_result import OrderBookQueryResult
...
from chimerabot.strategy.strategy_v2_base import MarketDataProvider
...
class TestMarketDataProvider(IsolatedAsyncioWrapperTestCase):
    ...
    def test_initialize_candles_feed(self):
        with patch('chimerabot.data_feed.candles_feed.candles_factory.CandlesFactory.get_candle', return_value=MagicMock()):
    ...
    def test_get_rate(self):
        with patch("chimerabot.core.rate_oracle.rate_oracle.RateOracle.get_instance") as mock_get_instance:
    ...
    @patch('chimerabot.core.rate_oracle.rate_oracle.RateOracle.get_instance')
    @patch('chimerabot.core.gateway.gateway_http_client.GatewayHttpClient.get_instance')
    ...
    def test_get_candles_feed_existing_feed_stop(self):
        ...
        with patch('chimerabot.data_feed.candles_feed.candles_factory.CandlesFactory.get_candle') as mock_get_candle:
    ...
    @patch('chimerabot.client.settings.AllConnectorSettings.get_connector_config_keys')
