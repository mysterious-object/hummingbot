...
class TestAmmGatewayDataFeed(IsolatedAsyncioWrapperTestCase, LoggerMixinForTest):
    ...
    @patch("chimerabot.data_feed.amm_gateway_data_feed.AmmGatewayDataFeed.gateway_client", new_callable=AsyncMock)
    ...
    @patch("chimerabot.data_feed.amm_gateway_data_feed.AmmGatewayDataFeed._async_sleep", new_callable=AsyncMock)
    @patch("chimerabot.data_feed.amm_gateway_data_feed.AmmGatewayDataFeed._fetch_data", new_callable=AsyncMock)
    ...
    def test_is_ready_with_prices(self):
        ...
        from chimerabot.data_feed.amm_gateway_data_feed import TokenBuySellPrice
        self.data_feed._price_dict = {
