...
class TestWalletTrackerDataFeed(IsolatedAsyncioWrapperTestCase, LoggerMixinForTest):
    ...
    @patch("chimerabot.data_feed.wallet_tracker_data_feed.WalletTrackerDataFeed.gateway_client", new_callable=AsyncMock)
    ...
    @patch("chimerabot.data_feed.wallet_tracker_data_feed.WalletTrackerDataFeed._async_sleep", new_callable=AsyncMock)
    @patch("chimerabot.data_feed.wallet_tracker_data_feed.WalletTrackerDataFeed._fetch_data", new_callable=AsyncMock)
    ...
    @patch("chimerabot.data_feed.wallet_tracker_data_feed.GatewayHttpClient.get_instance")
