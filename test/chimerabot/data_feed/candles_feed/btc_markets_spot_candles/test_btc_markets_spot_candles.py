...
from test.chimerabot.data_feed.candles_feed.test_candles_base import TestCandlesBase
...
class TestBtcMarketsSpotCandles(TestCandlesBase):
    ...
    def test_rest_url_property(self):
        ...
        from chimerabot.data_feed.candles_feed.btc_markets_spot_candles import constants as CONSTANTS
