...
from chimerabot.data_feed.liquidations_feed.binance import BinancePerpetualLiquidations, constants as CONSTANTS
from chimerabot.data_feed.liquidations_feed.liquidations_base import LiquidationSide
...
class TestBinanceLiquidations(IsolatedAsyncioWrapperTestCase):
    ...
    @patch("chimerabot.data_feed.liquidations_feed.binance.BinancePerpetualLiquidations._sleep")
