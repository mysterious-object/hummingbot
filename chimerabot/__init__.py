...
from chimerabot.logger.struct_logger import StructLogger, StructLogRecord

if TYPE_CHECKING:
    from chimerabot.client.config.config_helpers import ClientConfigAdapter as _ClientConfigAdapter
...
def chdir_to_data_directory():
    ...
    import appdirs
    app_data_dir: str = appdirs.user_data_dir("ChimeraBot", "chimerabot.io")
...
def get_logging_conf(conf_filename: str = 'chimerabot_logs.yml'):
    import io
...
def init_logging(conf_filename: str,
                 ...
                 strategy_file_path: str = "chimerabot"):
    import io
...
def get_strategy_list() -> List[str]:
    """
    Search `chimerabot.strategy` folder for all available strategies
