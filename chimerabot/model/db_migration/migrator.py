...
from chimerabot.model.db_migration.base_transformation import DatabaseTransformation
...
class Migrator:
    ...
    def _get_transformations(cls):
        import chimerabot.model.db_migration.transformations as transformations
