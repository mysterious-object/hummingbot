...
from chimerabot.logger.logger import ChimeraBotLogger
from chimerabot.model import get_declarative_base
from chimerabot.model.metadata import Metadata as LocalMetadata
from chimerabot.model.transaction_base import TransactionBase
...
class SQLConnectionManager(TransactionBase):
    _scm_logger: Optional[ChimeraBotLogger] = None
    ...
    def create_db_path(cls, db_path: Optional[str] = None, db_name: Optional[str] = None) -> str:
        ...
        if db_name is not None:
            ...
            return join(data_path(), "chimerabot_trades.sqlite")
    ...
    def __init__(self,
        ...
        if connection_type is SQLConnectionType.TRADE_FILLS:
            ...
            # See: `chimerabot/market/markets_recorder.py`, at line 213.
    ...
    def check_and_migrate_db(self, client_config_map: "ClientConfigAdapter"):
        from chimerabot.model.db_migration.migrator import Migrator
