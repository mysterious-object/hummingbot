...
from chimerabot.data_feed.liquidations_feed.binance.binance_liquidations import BinancePerpetualLiquidations
from chimerabot.data_feed.liquidations_feed.liquidations_base import LiquidationsBase
