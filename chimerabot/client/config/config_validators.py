"""
chimerabot.client.config.config_var defines ConfigVar. One of its parameters is a validator, a function that takes a
string and determines whether it is valid input. This file contains many validator functions that are used by various
chimerabot ConfigVars.
"""
...
def validate_connector(value: str) -> Optional[str]:
    ...
    """
    from chimerabot.client.settings import GATEWAY_CONNECTORS, AllConnectorSettings
...
def validate_strategy(value: str) -> Optional[str]:
    ...
    """
    from chimerabot.client.settings import STRATEGIES
