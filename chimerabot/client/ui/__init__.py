...
from chimerabot.client.config.conf_migration import migrate_configs, migrate_non_secure_configs_only
...
from chimerabot.client.settings import CONF_DIR_PATH
...
def login_prompt(secrets_manager_cls: Type[BaseSecretsManager], style: Style):
    ...
    if Security.new_password_required():
        ...
        password = input_dialog(
            title="Welcome back to ChimeraBot",
...
def migrate_configs_prompt(secrets_manager_cls: Type[BaseSecretsManager], style: Style) -> BaseSecretsManager:
    message_dialog(
        ...
        text="""
            ...
            We have recently refactored the way chimerabot handles configurations.
...
def show_welcome(style: Style):
    ...
    Version: {version}
    Codebase: https://github.com/chimerabot/chimerabot
    ...
    PLEASE READ THIS CAREFULLY BEFORE USING CHIMERABOT:

    ChimeraBot is a free and open source software client that helps you build algorithmic
    ...
    You are solely responsible for the trades that you perform using ChimeraBot.
    ...
    To use ChimeraBot, you will need to give it access to your crypto assets by entering
