...
from chimerabot.client.command.connect_command import OPTIONS as CONNECT_OPTIONS
from chimerabot.exceptions import ArgumentParserError
...
def load_parser(chimerabot: "ChimeraBotApplication", command_tabs) -> ThrowingArgumentParser:
    ...
    connect_parser.set_defaults(func=chimerabot.connect)
    ...
    create_parser.set_defaults(func=chimerabot.create)
    ...
    import_parser.set_defaults(func=chimerabot.import_command)
    ...
    help_parser.set_defaults(func=chimerabot.help)
    ...
    balance_parser.set_defaults(func=chimerabot.balance)
    ...
    config_parser.set_defaults(func=chimerabot.config)
    ...
    start_parser.set_defaults(func=chimerabot.start)

    stop_parser = subparsers.add_parser('stop', help="Stop the current bot")
    stop_parser.set_defaults(func=chimerabot.stop)
    ...
    status_parser.set_defaults(func=chimerabot.status)
    ...
    history_parser.set_defaults(func=chimerabot.history)

    gateway_parser = subparsers.add_parser("gateway", help="Helper commands for Gateway server.")
    gateway_parser.set_defaults(func=chimerabot.gateway)
    ...
    gateway_allowance_parser.set_defaults(func=chimerabot.gateway_allowance)
    ...
    gateway_approve_parser.set_defaults(func=chimerabot.gateway_approve)
    ...
    gateway_balance_parser.set_defaults(func=chimerabot.gateway_balance)
    ...
    gateway_config_parser.set_defaults(func=chimerabot.gateway_config)
    ...
    gateway_connect_parser.set_defaults(func=chimerabot.gateway_connect)

    gateway_cert_parser = gateway_subparsers.add_parser("generate-certs", help="Create SSL certificate")
    gateway_cert_parser.set_defaults(func=chimerabot.generate_certs)

    gateway_list_parser = gateway_subparsers.add_parser("list", help="List available connectors")
    gateway_list_parser.set_defaults(func=chimerabot.gateway_list)
    ...
    gateway_lp_parser.set_defaults(func=chimerabot.gateway_lp)
    ...
    gateway_ping_parser.set_defaults(func=chimerabot.gateway_ping)
    ...
    gateway_pool_parser.set_defaults(func=chimerabot.gateway_pool)
    ...
    gateway_swap_parser.set_defaults(func=chimerabot.gateway_swap)
    ...
    gateway_token_parser.set_defaults(func=chimerabot.gateway_token)
    ...
    exit_parser.add_argument("-f", "--force", action="store_true", help="Force exit without canceling outstanding orders",
                             default=False)
    exit_parser.set_defaults(func=chimerabot.exit)
    ...
    export_parser.set_defaults(func=chimerabot.export)
    ...
    ticker_parser.set_defaults(func=chimerabot.ticker)
    ...
    mqtt_start_parser.set_defaults(func=chimerabot.mqtt_start)
    mqtt_stop_parser = mqtt_subparsers.add_parser("stop", help="Stop the MQTT Bridge")
    mqtt_stop_parser.set_defaults(func=chimerabot.mqtt_stop)
    ...
    mqtt_restart_parser.set_defaults(func=chimerabot.mqtt_restart)
    ...
    rate_parser.set_defaults(func=chimerabot.rate)
