...
from chimerabot.client.settings import MAXIMUM_LOG_PANE_LINE_COUNT, MAXIMUM_OUTPUT_PANE_LINE_COUNT
from chimerabot.client.tab.data_types import CommandTab
from chimerabot.client.ui.custom_widgets import CustomTextArea as TextArea, FormattedTextLexer
...
======================================================================================
ChimeraBot is an open source software client that helps you build and run
market making, arbitrage, and other high-frequency trading bots.

- Official repo: https://github.com/chimerabot/chimerabot
- Join the community: https://discord.gg/chimerabot
- Learn market making: https://chimerabot.org/botcamp
