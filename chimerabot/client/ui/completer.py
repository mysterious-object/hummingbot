...
from chimerabot.client.ui.parser import ThrowingArgumentParser
from chimerabot.core.rate_oracle.rate_oracle import RATE_ORACLE_SOURCES
from chimerabot.core.utils.gateway_config_utils import list_gateway_wallets
...
class ChimeraBotCompleter(Completer):
    def __init__(self, chimerabot_application):
        super(ChimeraBotCompleter, self).__init__()
        self.chimerabot_application = chimerabot_application
    ...
    def prompt_text(self) -> str:
        return self.chimerabot_application.app.prompt_text

    @property
    def parser(self) -> ThrowingArgumentParser:
        return self.chimerabot_application.parser
    ...
    def _config_completer(self):
        config_keys = self.chimerabot_application.configurable_keys()
...
def load_completer(chimerabot_application):
    return ChimeraBotCompleter(chimerabot_application)
