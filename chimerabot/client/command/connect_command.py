...
class ConnectCommand:
    def connect(self,  # type: ChimeraBotApplication
                option: str):
        if option is None:
    ...
    async def connect_exchange(self,  # type: ChimeraBotApplication
                               connector_name):
    ...
    async def show_connections(self  # type: ChimeraBotApplication
                               ):
    ...
    async def connection_df(self  # type: ChimeraBotApplication
                            ):
        await Security.wait_til_decryption_done()
