...
from chimerabot import check_dev_mode
...
class StatusCommand:
    def _expire_old_application_warnings(self,  # type: ChimeraBotApplication
                                         ):
        now: float = time.time()
    ...
    def _format_application_warnings(self,  # type: ChimeraBotApplication
                                     ) -> str:
        lines: List[str] = []
    ...
    def status(self,  # type: ChimeraBotApplication
               live: bool = False):
    ...
    async def status_check_all(self,  # type: ChimeraBotApplication
                               notify_success=True,
                               live=False) -> bool:
