...
class MQTTCommand:
    ...
    def mqtt_start(self,  # type: ChimeraBotApplication
                   timeout: float = 30.0
                   ):
    ...
    def mqtt_stop(self,  # type: ChimeraBotApplication
                  ):
        if threading.current_thread() != threading.main_thread():
    ...
    def mqtt_restart(self,  # type: ChimeraBotApplication
                     timeout: float = 30.0
                     ):
        if threading.current_thread() != threading.main_thread():
    ...
    async def start_mqtt_async(self,  # type: ChimeraBotApplication
                               timeout: float = 30.0
                               ):
    ...
    async def stop_mqtt_async(self,  # type: ChimeraBotApplication
                              ):
    ...
    async def restart_mqtt_async(self,  # type: ChimeraBotApplication
                                 timeout: float = 2.0
                                 ):
