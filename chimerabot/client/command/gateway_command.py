...
from chimerabot.client.command.command_utils import GatewayCommandUtils
from chimerabot.client.command.gateway_api_manager import GatewayChainApiManager, begin_placeholder_mode
from chimerabot.client.config.client_config_map import ClientConfigMap
from chimerabot.client.config.config_helpers import get_connector_class  # noqa: F401
from chimerabot.client.config.security import Security
from chimerabot.client.performance import PerformanceMetrics
from chimerabot.client.settings import AllConnectorSettings, gateway_connector_trading_pairs  # noqa: F401
from chimerabot.client.ui.interface_utils import format_df_for_printout
from chimerabot.core.gateway import get_gateway_paths
from chimerabot.core.gateway.gateway_http_client import GatewayHttpClient, GatewayStatus
from chimerabot.core.utils.async_utils import safe_ensure_future
from chimerabot.core.utils.ssl_cert import create_self_sign_certs
...
class GatewayCommand(GatewayChainApiManager):
    ...
    def __init__(self,  # type: ChimeraBotApplication
                 client_config_map: ClientConfigMap
                 ):
...
Use 'gateway <command> --help' for more information about a command.""")
    ...
    def gateway_approve(self, connector: Optional[str], tokens: Optional[str]):
        ...
        from chimerabot.client.command.gateway_approve_command import GatewayApproveCommand
    ...
    def gateway_token(self, symbol_or_address: Optional[str], action: Optional[str]):
        ...
        from chimerabot.client.command.gateway_token_command import GatewayTokenCommand
    ...
    def gateway_pool(self, connector: Optional[str], trading_pair: Optional[str], action: Optional[str], args: List[str] = None):
        ...
        from chimerabot.client.command.gateway_pool_command import GatewayPoolCommand
    ...
    def gateway_config(self, namespace: str = None, action: str = None, args: List[str] = None):
        ...
        from chimerabot.client.command.gateway_config_command import GatewayConfigCommand
    ...
    async def _gateway_connect(
        self,  # type: ChimeraBotApplication
        chain: str
    ):
        """View and add wallets for a chain."""
        try:
    ...
    async def _get_balances(self, chain_filter: Optional[str] = None, tokens_filter: Optional[str] = None):
        ...
        if chain_filter:
            ...
            from chimerabot.connector.gateway.common_types import Chain
