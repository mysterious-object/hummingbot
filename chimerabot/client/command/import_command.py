...
from chimerabot.client.config.client_config_map import AutofillImportEnum
...
from chimerabot.client.settings import CONF_PREFIX, STRATEGIES_CONF_DIR_PATH, required_exchanges
...
class ImportCommand:
    ...
    def import_command(self,  # type: ChimeraBotApplication
                       file_name):
    ...
    async def import_config_file(self,  # type: ChimeraBotApplication
                                 file_name):
    ...
    async def prompt_a_file_name(self  # type: ChimeraBotApplication
                                 ):
