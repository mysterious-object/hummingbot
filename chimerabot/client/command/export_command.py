...
from chimerabot.client.settings import DEFAULT_LOG_FILE_PATH
...
class ExportCommand:
    def export(self,  # type: ChimeraBotApplication
               option):
    ...
    async def export_keys(self,  # type: ChimeraBotApplication
                          ):
    ...
    async def prompt_new_export_file_name(self,  # type: ChimeraBotApplication
                                          path):
    ...
    async def export_trades(self,  # type: ChimeraBotApplication
                            ):
