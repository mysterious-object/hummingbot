...
if TYPE_CHECKING:
    from chimerabot.connector.gateway.gateway_base import GatewayBase
...
class GatewayCommandUtils:
    ...
    async def monitor_transaction_with_timeout(
        ...
        :param app: ChimeraBotApplication instance (for notify method)
    ...
    async def prompt_for_confirmation(
        ...
        :param app: ChimeraBotApplication instance
