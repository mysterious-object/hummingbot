...
from chimerabot.client import settings
...
from chimerabot.client.settings import SCRIPT_STRATEGY_CONF_DIR_PATH, STRATEGIES_CONF_DIR_PATH, required_exchanges
...
from chimerabot.exceptions import InvalidController, InvalidScriptModule
from chimerabot.strategy.strategy_v2_base import StrategyV2ConfigBase
from chimerabot.strategy_v2.controllers.controller_base import ControllerConfigBase
from chimerabot.strategy_v2.controllers.directional_trading_controller_base import (
    DirectionalTradingControllerConfigBase,
)
from chimerabot.strategy_v2.controllers.market_making_controller_base import MarketMakingControllerConfigBase
...
class CreateCommand:
    def create(self,  # type: ChimeraBotApplication
    ...
    async def prompt_for_controller_config(self,  # type: ChimeraBotApplication
                                           controller_name: str):
        try:
    ...
    async def prompt_for_configuration_v2(self,  # type: ChimeraBotApplication
    ...
    async def prompt_for_configuration(
        ...
        self.notify(f"Please see https://docs.chimerabot.org/strategies/{strategy.replace('_', '-')}/ "
    ...
    async def prompt_new_file_name(self,  # type: ChimeraBotApplication
                                   strategy: str,
