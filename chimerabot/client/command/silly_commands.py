...
RESOURCES_PATH = "chimerabot/client/command/silly_resources/"


class SillyCommands:

    def be_silly(self,  # type: ChimeraBotApplication
                 raw_command: str) -> bool:
        command = raw_command.split(" ")[0]
        if command == "chimerabot":
            safe_ensure_future(self.silly_chimerabot())
            return True
        elif command == "roger":
    ...
    async def silly_jack(self,  # type: ChimeraBotApplication
                         ):
        self.placeholder_mode = True
        self.app.hide_input = True
        await self.text_n_wait("Hi there,", 1)
        await self.text_n_wait("This is Jack.", 1)
        await self.text_n_wait("I am the lead developer of ChimeraBot.", 1.5)
    ...
    async def silly_chimerabot(self,  # type: ChimeraBotApplication
                               ):
        self.placeholder_mode = True
        self.app.hide_input = True
        for _ in range(0, 3):
    ...
    async def silly_roger(self,  # type: ChimeraBotApplication
                          ):
        self.placeholder_mode = True
        self.app.hide_input = True
        for _ in range(0, 3):
    ...
    async def silly_victor(self,  # type: ChimeraBotApplication
                           ):
        self.placeholder_mode = True
        self.app.hide_input = True
    ...
    async def silly_rein(self,  # type: ChimeraBotApplication
                         ):
        self.placeholder_mode = True
        self.app.hide_input = True
        for _ in range(0, 2):
    ...
    async def silly_dennis(self,  # type: ChimeraBotApplication
                           ):
        self.placeholder_mode = True
        self.app.hide_input = True
