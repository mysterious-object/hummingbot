...
from chimerabot.client.config.config_validators import validate_decimal, validate_exchange
...
class BalanceCommand:
    def balance(self,  # type: ChimeraBotApplication
                option: str = None,
                args: List[str] = None
                ):
    ...
    async def exchange_balances_extra_df(self,  # type: ChimeraBotApplication
                                         exchange: str,
