...
from chimerabot.client.command import __all__ as commands
...
from chimerabot.client.config.gateway_ssl_config_map import SSLConfigMap
from chimerabot.client.config.strategy_config_data_types import BaseStrategyConfigMap
from chimerabot.client.settings import CLIENT_CONFIG_PATH
from chimerabot.client.tab import __all__ as tab_classes
from chimerabot.client.tab.data_types import CommandTab
from chimerabot.client.ui.completer import load_completer
from chimerabot.client.ui.chimerabot_cli import ChimeraBotCLI
from chimerabot.client.ui.keybindings import load_key_bindings
from chimerabot.client.ui.parser import ThrowingArgumentParser, load_parser
from chimerabot.connector.exchange_base import ExchangeBase
from chimerabot.core.trading_core import TradingCore
from chimerabot.core.utils.trading_pair_fetcher import TradingPairFetcher
from chimerabot.exceptions import ArgumentParserError
from chimerabot.logger import ChimeraBotLogger
from chimerabot.logger.application_warning import ApplicationWarning
...
class ChimeraBotApplication(*commands):
    KILL_TIMEOUT = 20.0
    APP_WARNING_EXPIRY_DURATION = 3600.0
    APP_WARNING_STATUS_LIMIT = 6

    _main_app: Optional["ChimeraBotApplication"] = None
    ...
    @classmethod
    def main_application(cls, client_config_map: Optional[ClientConfigAdapter] = None, headless_mode: bool = False) -> "ChimeraBotApplication":
        if cls._main_app is None:
            cls._main_app = ChimeraBotApplication(client_config_map=client_config_map, headless_mode=headless_mode)
    ...
    async def run_headless(self):
        ...
        try:
            self.logger().info("Starting ChimeraBot in headless mode...")
    ...
    def init_command_tabs(self) -> Dict[str, CommandTab]:
        ...
        populated later on by ChimeraBotCLI
        """
