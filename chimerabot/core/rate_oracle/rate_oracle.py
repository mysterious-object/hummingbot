...
import chimerabot.client.settings  # noqa
from chimerabot.connector.utils import combine_to_hb_trading_pair
from chimerabot.core.network_base import NetworkBase
from chimerabot.core.network_iterator import NetworkStatus
from chimerabot.core.rate_oracle.sources.ascend_ex_rate_source import AscendExRateSource
from chimerabot.core.rate_oracle.sources.binance_rate_source import BinanceRateSource
from chimerabot.core.rate_oracle.sources.coin_cap_rate_source import CoinCapRateSource
from chimerabot.core.rate_oracle.sources.coin_gecko_rate_source import CoinGeckoRateSource
from chimerabot.core.rate_oracle.sources.coinbase_advanced_trade_rate_source import CoinbaseAdvancedTradeRateSource
from chimerabot.core.rate_oracle.sources.cube_rate_source import CubeRateSource
from chimerabot.core.rate_oracle.sources.derive_rate_source import DeriveRateSource
from chimerabot.core.rate_oracle.sources.dexalot_rate_source import DexalotRateSource
from chimerabot.core.rate_oracle.sources.gate_io_rate_source import GateIoRateSource
from chimerabot.core.rate_oracle.sources.hyperliquid_perpetual_rate_source import HyperliquidPerpetualRateSource
from chimerabot.core.rate_oracle.sources.hyperliquid_rate_source import HyperliquidRateSource
from chimerabot.core.rate_oracle.sources.kucoin_rate_source import KucoinRateSource
from chimerabot.core.rate_oracle.sources.mexc_rate_source import MexcRateSource
from chimerabot.core.rate_oracle.sources.rate_source_base import RateSourceBase
from chimerabot.core.rate_oracle.utils import find_rate
...
class RateOracle(NetworkBase):
    ...
    """
    _logger: Optional[ChimeraBotLogger] = None
