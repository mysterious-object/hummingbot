...
from chimerabot.core.utils import async_ttl_cache
from chimerabot.core.utils.async_utils import safe_gather
from chimerabot.data_feed.coin_gecko_data_feed import CoinGeckoDataFeed
from chimerabot.data_feed.coin_gecko_data_feed.coin_gecko_constants import COOLOFF_AFTER_BAN, CoinGeckoAPITier
...
class CoinGeckoRateSource(RateSourceBase):
    ...
    async def _get_coin_gecko_extra_token_prices(self, vs_currency: str) -> Dict[str, Decimal]:
        ...
        """
        results = {}
        # TODO: Should we force chimerabot to be included?
        # self._extra_token_ids.append("chimerabot") - This fails the tests, not sure why
