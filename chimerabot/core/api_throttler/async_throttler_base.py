...
from chimerabot.core.api_throttler.async_request_context_base import AsyncRequestContextBase
from chimerabot.core.api_throttler.data_types import RateLimit, TaskLog
...
class AsyncThrottlerBase(ABC):
    ...
    def _client_config_map(self):
        from chimerabot.client.chimerabot_application import ChimeraBotApplication  # avoids circular import

        return ChimeraBotApplication.main_application().client_config_map
