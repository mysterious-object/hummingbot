...
from chimerabot.core.event.events import TradeType
from chimerabot.core.utils.async_utils import safe_ensure_future
from chimerabot.core.utils.gateway_config_utils import build_config_namespace_keys
...
class GatewayHttpClient:
    ...
    _ghc_logger: Optional[ChimeraBotLogger] = None
    ...
    def log_error_codes(self, resp: Dict[str, Any]):
        ...
        if error_code is not None:
            if error_code == GatewayError.Network.value:
                ...
                self.logger().network("Some values was uninitialized. Please contact dev@chimerabot.io ")
                ...
                self.logger().network("An unknown error has occurred on gateway. Please send your logs to operations@chimerabot.org.")
            else:
                self.logger().network("An unknown error has occurred on gateway. Please send your logs to operations@chimerabot.org.")
