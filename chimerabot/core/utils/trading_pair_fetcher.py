...
from chimerabot.client.settings import AllConnectorSettings, ConnectorSetting
...
class TradingPairFetcher:
    ...
    _tpf_logger: Optional[ChimeraBotLogger] = None
    ...
    def _get_client_config_map() -> "ClientConfigAdapter":
        ...
        client_config_map = ChimeraBotApplication.main_application().client_config_map
