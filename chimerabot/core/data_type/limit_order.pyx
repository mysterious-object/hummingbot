...
# distutils: sources=chimerabot/core/cpp/LimitOrder.cpp
import time
...
from chimerabot.core.data_type.common import PositionAction, OrderType
from chimerabot.core.event.events import LimitOrderStatus
