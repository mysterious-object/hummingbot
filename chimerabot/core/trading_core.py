...
from chimerabot.client.config.config_helpers import ClientConfigAdapter, get_strategy_starter_file
from chimerabot.client.config.strategy_config_data_types import BaseStrategyConfigMap
from chimerabot.client.performance import PerformanceMetrics
from chimerabot.client.settings import SCRIPT_STRATEGIES_MODULE, STRATEGIES
from chimerabot.connector.connector_metrics_collector import DummyMetricsCollector, MetricsCollector
...
from chimerabot.core.clock import Clock, ClockMode
from chimerabot.core.connector_manager import ConnectorManager
...
from chimerabot.core.utils.kill_switch import KillSwitch
from chimerabot.exceptions import InvalidScriptModule
from chimerabot.logger import ChimeraBotLogger
from chimerabot.model.sql_connection_manager import SQLConnectionManager
from chimerabot.model.trade_fill import TradeFill
from chimerabot.notifier.notifier_base import NotifierBase
from chimerabot.strategy.directional_strategy_base import DirectionalStrategyBase
from chimerabot.strategy.market_trading_pair_tuple import MarketTradingPairTuple
from chimerabot.strategy.script_strategy_base import ScriptStrategyBase
from chimerabot.strategy.strategy_base import StrategyBase
...
class TradingCore:
    ...
    def load_script_class(self, script_name: str) -> Tuple[Type, Optional[BaseClientModel]]:
        """
        Load script strategy class following ChimeraBot's pattern.
    ...
    def _load_script_yaml_config(self, config_file_path: str) -> Dict[str, Any]:
        ...
        from chimerabot.client.settings import SCRIPT_STRATEGY_CONF_DIR_PATH
