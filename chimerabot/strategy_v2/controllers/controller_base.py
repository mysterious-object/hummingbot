...
from chimerabot.core.data_type.common import MarketDict
...
from chimerabot.strategy_v2.models.executor_actions import ExecutorAction
...
from chimerabot.strategy_v2.runnable_base import RunnableBase
from chimerabot.strategy_v2.utils.common import generate_unique_id
...
class ControllerConfigBase(BaseClientModel):
    """
    This class represents the base configuration for a controller in the ChimeraBot trading bot.
