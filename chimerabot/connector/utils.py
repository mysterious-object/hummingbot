...
from chimerabot.core.utils.tracking_nonce import NonceCreator, get_tracking_nonce
from chimerabot.core.web_assistant.connections.data_types import RESTRequest, WSResponse
...
def get_new_client_order_id(
    ...
    :param hbot_order_id_prefix: The chimerabot-specific identifier for the given exchange
