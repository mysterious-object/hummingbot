...
from chimerabot.connector.derivative.hyperliquid_perpetual import (
...
from chimerabot.connector.derivative.hyperliquid_perpetual.hyperliquid_perpetual_auth import HyperliquidPerpetualAuth
from chimerabot.connector.derivative.hyperliquid_perpetual.hyperliquid_perpetual_user_stream_data_source import (
...
class HyperliquidPerpetualDerivative(PerpetualDerivativePyBase):
    ...
    def __init__(
        ...
        self.hip_3_result: List[Dict[str, Any]] = []
    ...
    async def _format_trading_rules(self, exchange_info_dict: List) -> List[TradingRule]:
        ...
        for dex_info in self.hip_3_result:
            try:
