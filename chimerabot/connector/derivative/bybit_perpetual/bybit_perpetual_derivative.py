...
import chimerabot.connector.derivative.bybit_perpetual.bybit_perpetual_constants as CONSTANTS
import chimerabot.connector.derivative.bybit_perpetual.bybit_perpetual_utils as bybit_utils
from chimerabot.connector.derivative.bybit_perpetual import bybit_perpetual_web_utils as web_utils
from chimerabot.connector.derivative.bybit_perpetual.bybit_perpetual_api_order_book_data_source import (
    BybitPerpetualAPIOrderBookDataSource,
)
from chimerabot.connector.derivative.bybit_perpetual.bybit_perpetual_auth import BybitPerpetualAuth
from chimerabot.connector.derivative.bybit_perpetual.bybit_perpetual_user_stream_data_source import (
    ...
    def supported_position_modes(self) -> List[PositionMode]:
        if all(bybit_utils.is_linear_perpetual(tp) for tp in self._trading_pairs):
            ...
            self.logger().warning(
                ...
                " Please start another chimerabot instance."
            )
            return []
