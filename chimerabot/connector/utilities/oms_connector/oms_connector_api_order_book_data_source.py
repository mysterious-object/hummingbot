...
from chimerabot.connector.utilities.oms_connector import oms_connector_constants as CONSTANTS
...
from chimerabot.core.web_assistant.connections.data_types import RESTMethod, WSJSONRequest
...
if TYPE_CHECKING:
    from chimerabot.connector.utilities.oms_connector.oms_connector_exchange import OMSExchange
...
class OMSConnectorAPIOrderBookDataSource(OrderBookTrackerDataSource):
    ...
    async def subscribe_to_trading_pair(self, trading_pair: str) -> bool:
        """
        Subscribe to order book channel for a single trading pair.
        ...
        try:
            ...
            self.logger().info(f"Subscribed to public order book channel of {trading_pair}...")
            return True
        except asyncio.CancelledError:
            raise
        except Exception:
    ...
    async def unsubscribe_from_trading_pair(self, trading_pair: str) -> bool:
        """
        Unsubscribe from order book channel for a single trading pair.
        ...
        try:
            ...
            payload = {
                CONSTANTS.MSG_ENDPOINT_FIELD: CONSTANTS.WS_L2_UNSUB_ENDPOINT,
                CONSTANTS.MSG_DATA_FIELD: req_params,
            }
            ...
            self.logger().info(f"Unsubscribed from public order book channel of {trading_pair}...")
            return True
        except asyncio.CancelledError:
            raise
        except Exception:
