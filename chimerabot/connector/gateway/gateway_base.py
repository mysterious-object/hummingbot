...
from chimerabot.connector.gateway.common_types import TransactionStatus
...
from chimerabot.core.data_type.in_flight_order import OrderState, OrderUpdate, TradeFeeBase, TradeUpdate
...
from chimerabot.core.utils.tracking_nonce import get_tracking_nonce
...
class GatewayBase(ConnectorBase):
    ...
    def logger(cls) -> ChimeraBotLogger:
        ...
        return cast(ChimeraBotLogger, s_logger)
    ...
    async def cancel_all(self, timeout_seconds: float) -> List[CancellationResult]:
        ...
        ChimeraBot to force cancel all orders whenever ChimeraBot quits.
        """
        return []
