...
from chimerabot.connector.exchange.vertex import (
...
from chimerabot.connector.exchange.vertex.vertex_api_user_stream_data_source import VertexAPIUserStreamDataSource
from chimerabot.connector.exchange.vertex.vertex_auth import VertexAuth
