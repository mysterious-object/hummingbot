...
from chimerabot.connector.exchange.bitstamp import bitstamp_constants as CONSTANTS, bitstamp_web_utils as web_utils
from chimerabot.connector.exchange.bitstamp.bitstamp_order_book import BitstampOrderBook
...
if TYPE_CHECKING:
    from chimerabot.connector.exchange.bitstamp.bitstamp_exchange import BitstampExchange
...
class BitstampAPIOrderBookDataSource(OrderBookTrackerDataSource):
    ...
    async def unsubscribe_from_trading_pair(self, trading_pair: str) -> bool:
        ...
        try:
            ...
            trade_channel = CONSTANTS.WS_PUBLIC_LIVE_TRADES.format(symbol)
            payload = {
            ...
            orderbook_channel = CONSTANTS.WS_PUBLIC_DIFF_ORDER_BOOK.format(symbol)
            payload = {
                "event": "bts:unsubscribe",
                "data": {
            ...
            self._channel_associated_to_tradingpair.pop(trade_channel, None)
            self._channel_associated_to_tradingpair.pop(orderbook_channel, None)
