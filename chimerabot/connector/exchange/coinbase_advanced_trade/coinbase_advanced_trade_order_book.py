...
from chimerabot.connector.exchange.coinbase_advanced_trade.coinbase_advanced_trade_constants import (
...
class CoinbaseAdvancedTradeOrderBook(OrderBook):
    ...
    def diff_message_from_exchange(
        ...
        :param msg: the response from the exchange when requesting the order book snapshot
        :param symbol_to_pair: Method to retrieve a ChimeraBot trading pair from an exchange symbol
        :return: a snapshot message with the snapshot information received from the exchange
        {
            'channel': 'l2_data',
            'client_id': '',
