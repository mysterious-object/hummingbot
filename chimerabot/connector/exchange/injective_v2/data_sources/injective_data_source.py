...
from chimerabot.connector.exchange.injective_v2.injective_market import (
    InjectiveDerivativeMarket,
    InjectiveSpotMarket,
    InjectiveToken,
)
from chimerabot.connector.gateway.common_types import CancelOrderResult, PlaceOrderResult
from chimerabot.connector.gateway.gateway_in_flight_order import GatewayInFlightOrder, GatewayPerpetualInFlightOrder
from chimerabot.connector.trading_rule import TradingRule
from chimerabot.core.api_throttler.async_throttler_base import AsyncThrottlerBase
from chimerabot.core.data_type.common import OrderType, PositionAction, PositionSide, TradeType
...
from chimerabot.core.data_type.trade_fee import TokenAmount, TradeFeeBase, TradeFeeSchema
...
class InjectiveDataSource(ABC):
    ...
    def logger(cls) -> ChimeraBotLogger:
        if cls._logger is None:
            cls._logger = logging.getLogger(ChimeraBotLogger.logger_name_for_class(cls))
        return cls._logger
