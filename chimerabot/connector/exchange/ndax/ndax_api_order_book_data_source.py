...
from chimerabot.connector.exchange.ndax import ndax_constants as CONSTANTS, ndax_web_utils as web_utils
from chimerabot.connector.exchange.ndax.ndax_order_book import NdaxOrderBook
from chimerabot.connector.exchange.ndax.ndax_order_book_message import NdaxOrderBookEntry
...
if TYPE_CHECKING:
    from chimerabot.connector.exchange.ndax.ndax_exchange import NdaxExchange
...
class NdaxAPIOrderBookDataSource(OrderBookTrackerDataSource):
    ...
    async def subscribe_to_trading_pair(self, trading_pair: str) -> bool:
        ...
        try:
            ...
            await self._ws_assistant.send_request(endpoint_name=CONSTANTS.WS_ORDER_BOOK_CHANNEL, payload=payload)
    ...
    async def unsubscribe_from_trading_pair(self, trading_pair: str) -> bool:
        ...
        try:
            ...
            await self._ws_assistant.send_request(endpoint_name=CONSTANTS.WS_UNSUBSCRIBE_ORDER_BOOK, payload=payload)
