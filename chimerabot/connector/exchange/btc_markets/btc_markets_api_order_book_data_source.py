...
from chimerabot.connector.exchange.btc_markets import btc_markets_web_utils as web_utils
from chimerabot.connector.exchange.btc_markets.btc_markets_order_book import BtcMarketsOrderBook
...
class BtcMarketsAPIOrderBookDataSource(OrderBookTrackerDataSource):
    ...
    async def subscribe_to_trading_pair(self, trading_pair: str) -> bool:
        ...
        try:
            ...
            async with self._api_factory.throttler.execute_task(limit_id=CONSTANTS.WS_SUBSCRIPTION_LIMIT_ID):
                await self._ws_assistant.send(subscription_request)
    ...
    async def unsubscribe_from_trading_pair(self, trading_pair: str) -> bool:
        ...
        try:
            ...
            async with self._api_factory.throttler.execute_task(limit_id=CONSTANTS.WS_SUBSCRIPTION_LIMIT_ID):
                await self._ws_assistant.send(unsubscription_request)
