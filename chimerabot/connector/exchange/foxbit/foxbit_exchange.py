...
from chimerabot.connector.exchange.foxbit import (
...
from chimerabot.connector.exchange.foxbit.foxbit_api_user_stream_data_source import FoxbitAPIUserStreamDataSource
from chimerabot.connector.exchange.foxbit.foxbit_auth import FoxbitAuth
...
from chimerabot.connector.utils import TradeFillOrderDetails, combine_to_hb_trading_pair
...
from chimerabot.core.web_assistant.connections.data_types import WSJSONRequest, WSResponse
        ...
        if current_tick > last_tick and len(tracked_orders) > 0:
            ...
            for order_update, tracked_order in zip(results, tracked_orders):
                ...
                if isinstance(order_update, Exception):
                    ...
                    # it as failed. See: https://github.com/CoinAlpha/chimerabot/issues/601
