...
from chimerabot.core.event.events import MarketEvent, AccountEvent
...
from chimerabot.core.data_type.common import OrderType, PositionAction
...
cdef class StrategyBase(TimeIterator):
    ...
    def notify_hb_app(self, msg: str):
        ...
        ChimeraBotApplication.main_application().notify(msg)
