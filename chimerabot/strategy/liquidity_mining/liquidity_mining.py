...
from chimerabot.connector.parrot import get_campaign_summary
...
from chimerabot.strategy.pure_market_making.inventory_skew_calculator import (
...
class LiquidityMiningStrategy(StrategyPyBase):
    ...
    def did_fill_order(self, event):
        """
        Check if order has been completed, log it, notify the chimerabot application, and update budgets.
        """
    ...
    def notify_hb_app(self, msg: str):
        """
        Send a message to the chimerabot application
        """
