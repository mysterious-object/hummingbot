...
from chimerabot.core.data_type.common import MarketDict, PositionMode
...
from chimerabot.remote_iface.mqtt import ETopicPublisher
...
from chimerabot.strategy_v2.executors.executor_orchestrator import ExecutorOrchestrator
...
class StrategyV2Base(ScriptStrategyBase):
    ...
    def start(self, clock: Clock, timestamp: float) -> None:
        ...
        if ChimeraBotApplication.main_application()._mqtt is not None:
